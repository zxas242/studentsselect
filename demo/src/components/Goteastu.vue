<template>
  ...
  <p class="head">选课程目录：</p>
 <el-table class="table_box" :data="newtableData" style="width: 95%;font-size:13px;color:rgb(46, 142, 221);" max-height="100%">
    <el-table-column fixed prop="courseid" label="课程代码" width="100"></el-table-column>
    ...
    <el-table-column prop="property" label="性质" width="100"></el-table-column>
    <el-table-column prop="classhours" label="学时" width="50"></el-table-column>
    <el-table-column prop="credit" label="可获学分" width="80"></el-table-column>
    <el-table-column prop="testway" label="考核方式" width="100"></el-table-column>
    <el-table-column prop="time" label="学期" width="150"></el-table-column>
    <el-table-column prop="name" label="选课学生" width="100"></el-table-column>
    <el-table-column prop="id" label="学生编号" width="100"></el-table-column>
    <el-table-column prop="Introduction" label="课程介绍" width="300"></el-table-column>
...
<script>
  export default {
    ...
    props:{},
     data() {
      return {
        tableData:[], newtableData:[], page:1, star:0, end:7, temp:[], input:""
      }
    },
   mounted() {
    ...
    created() {
     this.axios.get("/api/course/getgoteastu").then(res=>{
          /* 展示7条数据 */
